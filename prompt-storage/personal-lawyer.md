...
> This prompt requires a significant number of tokens; at present, I believe only Google Gemini models can effectively handle it, or you'd need to live in a country with very minimalistic laws (I'm looking at you, minarchism, but I don't think such a country exists, LOL).

- Google
	-  Gemini 2.5 Flash - This model works, but using more powerful models is better.
	- Gemini 2.5 Pro - Currently, there isn't a better model for this prompt. So, definitely use `personal-lawyer.md` with Gemini 2.5 Pro.
- OpenAI
	- ChatGPT-4o - You may try it, but I'm sure most PDFs will exceed its context window. ChatGPT-4o has only 128K tokens.
